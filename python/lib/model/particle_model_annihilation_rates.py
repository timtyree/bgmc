...
def compute_particle_model_interp(
    # reflect=0,
    # force_code=2,
    # set_second=0,
    # no_attraction=0,
...
def recall_particle_model_interp_unattractive(
    reflect=0,
    force_code=2,
    set_second=0,
    no_attraction=0,
    ...
    **kwargs):
    ...
    Example Usage:
    interp=recall_particle_model_interp_unattractive()
    ...
    #define parameters to be varied
    # input_cols=['r','D','varkappa']#~2 minute runtime?
    input_cols=['r','kappa','D']#~2 minute runtime
    # output_cols=['m','Delta_m','M','Delta_M']#~2 minute runtime
    output_cols=['m','M']#2.75 minute runtime paradoxically...
    #inputs:dg,input_cols,output_col
    #output: fitted model
