...
R_c_bar_values = np.arange(0,0.86,0.01)
...
for L in L_values:
    for R_c_bar in R_c_bar_values:
        ...
        #             count+=1
                    #FK
                    #.                      R_c_bar Mp nup                                r0
                    # args=seed, Ninitial, 0, 0.85, 0.864, 0.230, chi, 15, 0.457, a, 0.048, 0.131, L, creation_duration, dt #modified
                    # args=seed, Ninitial, 0, 0.85, 0.864, 0.230, chi, 15, 0.457, a, 0.115, 0.131, L, creation_duration, dt
                    args=seed, Ninitial, 0, R_c_bar, 0.864, 0.230, chi, 15, 0.457, a, 0.115, 0.131, L, creation_duration, dt
        #             print(*args)
                    count+=1
                    #record
                    args_lst.append(args)
