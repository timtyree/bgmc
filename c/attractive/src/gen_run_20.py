...
D_values=np.arange(0.1,8.1,0.1)
r_values=np.array([0.03,0.05,0.07,0.1,0.15,0.2,0.3,0.4,0.5])#,0.2,0.3,0.4,0.5])# cm
kappa_values = np.array([250,300,400,500,600,700,800,900,1000,1500])#,1000,1500]) #Hz
